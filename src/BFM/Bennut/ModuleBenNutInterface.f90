...
!     integer,intent(IN) ::input
      ...
      SUBROUTINE FindLayerNr(NUTR,mode,x,layernr,xb)
      USE global_mem, ONLY:RLEN
      implicit none
      ...
      REAL(RLEN) FUNCTION CalculateFromLayer(NUTR,mode,option,input, &
                                                          xinput,yinput)
      USE global_mem, ONLY:RLEN
      implicit none
      integer,intent(IN) ::mode
      ...
      REAL(RLEN),intent(IN) ::xinput
      REAL(RLEN),intent(IN) ::yinput
      end FUNCTION CalculateFromLayer
      end INTERFACE
