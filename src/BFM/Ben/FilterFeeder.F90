...
! fsat=su/(NZERO+ et*eO*edry * vum*food)
  ...
  se_uZIR6c  =   suf*min(p_puePI(y),DONE-p_peZ_R1c)
  se_uZIR1c  =   suf*p_puePI(y)-se_uZIR6c
  se_uZIR6n  =   suf*min(p_puePI(y),DONE-p_peZ_R1n)
  se_uZIR1n  =   suf*p_puePI(y)-se_uZIR6n
  se_uZIR6p  =   suf*min(p_puePI(y),DONE-p_peZ_R1p)
  se_uZIR1p  =   suf*p_puePI(y)-se_uZIR6p
  se_uZER6c  =   suf*min(p_puePI(y),DONE-p_peZ_R1c)
  se_uZER1c  =   suf*p_puePI(y)-se_uZIR6c
  se_uZER6n  =   suf*min(p_puePI(y),DONE-p_peZ_R1n)
  se_uZER1n  =   suf*p_puePI(y)-se_uZIR6n
  se_uZER6p  =   suf*min(p_puePI(y),DONE-p_peZ_R1p)
  se_uZER1p  =   suf*p_puePI(y)-se_uZIR6p
