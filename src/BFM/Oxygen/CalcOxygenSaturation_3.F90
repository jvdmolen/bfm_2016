...
! !USES:
  ...
  ! The following Pelagic 1-d global boxvars are modified : cmO2o
  ...
  use global_mem, ONLY:RLEN,ZERO_KELVIN,NZERO,LOGUNIT
#ifdef NOPOINTERS
  use mem,  ONLY: D3STATE
#else
  use mem,  ONLY: O2o
#endif
  use mem, ONLY: cmO2o, eO2mO2, ETW, ESW, NO_BOXES
!  
!
! !AUTHORS
!   Piet Ruardij
...
!
  ...
  cmO2o(:)  =   h/ 24.4665D-3
  call findnan(cmO2o,NO_BOXES,iout)
  eO2mO2(:)  =   max(NZERO,O2o(:))/ cmO2o(:)
