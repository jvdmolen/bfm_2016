...
!  !BFM
!   -make the routine ed_2d public
!    See further in init_2dbio_ncdf.F90 
!   -Error improved: in case of cartesian coordinates xc and yc get no
!    values: code added to do it.
! 
! !USES:
  use netcdf
  use exceptions
