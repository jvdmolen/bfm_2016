...
! Indices into common arrays:                  ! Subroutine to time:
   ...
   integer, parameter :: TIM_UVADVH    =  9     ! 2d uv_advect haloz
...
#ifdef ADV_231
   integer, parameter :: TIM_ADV         = 200  ! 2d advection 
   integer, parameter :: TIM_ADVH        = 201  ! 2d advectiond halo-part 
#endif
...
#ifdef ADV_231
   timernames(TIM_UVADV)    = 'uv_advect'
   timernames(TIM_UVDIFF)    = 'uv_diffusion'
#else
