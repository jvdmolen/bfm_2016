...
!  
! !BFM
!    a variable dl (=daylength) is defined which is needed in the BFM model
!    the daylength is calculated in short_wave_radiation 
!
! !SEE ALSO:
...
! !PUBLIC DATA MEMBERS:
   ...
   REALTYPE, public, dimension(:,:), allocatable  :: airp,tausx,tausy,swr,shf,dl
