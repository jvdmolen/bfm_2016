...
!BOC
   ...
   do i=nlev,1,-1
!JM     write(unit,116) z(i),tprof(i),sprof(i),uprof(i),vprof(i),epsprof(i)
     write(unit,116) z(i),tprof%data(i),sprof%data(i),uprof%data(i),vprof%data(i),epsprof%data(i)
   end do
...
!JM 116 format(F10.4,2(1x,F10.6),3(2x,E10.4E2))
116 format(F10.4,2(1x,F10.6),3(1x,E10.4E2))
