...
!  and surface heat flux (W/m^2)
   ...
   REALTYPE, public,target             :: daylength
...
#ifdef BFM_GOTM
         call short_wave_radiation(jul,secs,dlon,dlat,cloud,I_0,daylength)
#else
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t
   REALTYPE, SAVE            :: dt
   integer(8), save          :: meteo_jul1
   integer, save             :: meteo_secs1
   integer(8), save          :: meteo_jul2=0
   integer, save             :: meteo_secs2=0
   REALTYPE, save            :: obs(7)
...
#ifdef bfm_gotm
   if (meteo_year.gt.0) then
      call calendar_date(jul,yy,mm,dd)
      if ( old_yy > 0) then
         if ( yy> old_yy ) then
            meteo_jul2=0;meteo_secs2=0
            rewind(meteo_unit)
            STDERR 'rewinding meteo_file....'
         endif
      endif
      old_yy=yy
      call julian_day(meteo_year,mm,dd,jul)
   endif
#endif
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t,alpha
   REALTYPE, save            :: dt
   integer(8), save          :: swr_jul1
   integer, save             :: swr_secs1
   integer(8), save          :: swr_jul2=0
   integer, save             :: swr_secs2=0
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t,alpha
   REALTYPE, SAVE            :: dt
   integer(8), save          :: heat_jul1
   integer, save             :: heat_secs1
   integer(8),save           :: heat_jul2=0
   integer, save             :: heat_secs2=0
   REALTYPE, save            :: obs1(1),obs2(1)=0.
   integer                   :: rc
!
!-----------------------------------------------------------------------
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t,alpha
   REALTYPE, save            :: dt
   integer(8), save          :: mom_jul1
   integer, save             :: mom_secs1
   integer(8), save          :: mom_jul2=0
   integer, save             :: mom_secs2=0
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t,alpha
   REALTYPE, save            :: dt
   integer(8), save          :: precip_jul1
   integer, save             :: precip_secs1
   integer(8), save          :: precip_jul2=0
   integer, save             :: precip_secs2=0
   REALTYPE, save            :: obs1(1),obs2(1)=0.
   integer                   :: rc
!
!-----------------------------------------------------------------------
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t,alpha
   REALTYPE, save            :: dt
   integer(8), save          :: sst_jul1
   integer, save             :: sst_secs1
   integer(8), save          :: sst_jul2=0
   integer, save             :: sst_secs2=0
   REALTYPE, save            :: obs1(1),obs2(1)=0.
   integer                   :: rc
!
!-----------------------------------------------------------------------
...
! !LOCAL VARIABLES:
   ...
   REALTYPE                  :: t,alpha
   REALTYPE, save            :: dt
   integer(8), save          :: sss_jul1
   integer, save             :: sss_secs1
   integer(8), save          :: sss_jul2=0
   integer, save             :: sss_secs2=0
   REALTYPE, save            :: obs1(1),obs2(1)=0.
   integer                   :: rc
!
!-----------------------------------------------------------------------
